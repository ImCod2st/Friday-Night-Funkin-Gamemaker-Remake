...
if (keyboard_check_pressed(vk_up)) || (keyboard_check_pressed(global.upKeybind)) {if (curSelected > 0) curSelected--;}
if (keyboard_check_pressed(vk_down)) || (keyboard_check_pressed(global.downKeybind)) {if (curSelected < optionAmount[category]) curSelected++;}
...
if (curSelected = 0) {
	if (keyboard_check_pressed(vk_left)) || (keyboard_check_pressed(global.leftKeybind)) {if (category > 0) category--;}
	if (keyboard_check_pressed(vk_right)) || (keyboard_check_pressed(global.rightKeybind)) {if (category < 1) category++;}
}
